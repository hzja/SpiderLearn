...
![23e6d1e39ce3c05a18cd9cb06ba3ee6b](./img/23e6d1e39ce3c05a18cd9cb06ba3ee6b.png)

![31c8610e409d7725eda2b32db49ba3da](./img/31c8610e409d7725eda2b32db49ba3da.png)



目测，有这四个参数需要分析，分析之前先搜索，免得是接口返回，发现 `Authorization` 和 `X-Auth-Token` 是另外一个 `ceb-omnix_proxy` 接口返回的：

![c573b9269f7bdec98624a63ec551fef3](./img/c573b9269f7bdec98624a63ec551fef3.png)



该接口有四个参数需要分析，也是有两个 `content`，估计都大差不差，我们继续先搜索，发现 `authorization` 是 `main.xxx.js` 文件返回的：

![6071728544d22169a970453f83a90c3a](./img/6071728544d22169a970453f83a90c3a.png)



而 `main.xxx.js` 文件是通过首页加载的，大致流程都梳理清晰了，我们开始进行逆向分析：

![41b329b42434e43e50f094ad3b36394a](./img/41b329b42434e43e50f094ad3b36394a.png)
