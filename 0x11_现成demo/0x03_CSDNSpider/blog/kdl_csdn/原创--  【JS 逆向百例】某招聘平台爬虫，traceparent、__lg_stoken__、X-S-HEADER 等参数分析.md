...
另外即便是把所有参数都补齐了，某勾网对于单个 IP 还有频率限制，抓不了几次就要求登录，可自行搭配代理进行抓取，或者复制账号登录后的 cookies 到代码里，可以解除限制，如果是账号登录后访问，请求头多了两个参数，即 `x-anit-forge-code` 和 `x-anit-forge-token`，经过测试这两个参数其实不要也行。
...
![13](https://img-blog.csdnimg.cn/e838a2805ba64d56a6078d9a08576d23.png<br/> <img alt="14" src="https://i-blog.csdnimg.cn/blog_migrate/517cc40a89ab7071192da92f33c1689d.png"/>
