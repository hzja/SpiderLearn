...
<h3>1.2、知识:</h3>
1、rsync
rsync是linux系统下的数据镜像备份工具。使用快速增量备份工具Remote Sync可以可以在本地计算机与远程计算机之间（与其他SSH、rsync主机同步），或者两个本地目录之间同步文件（但不支持两台远程计算机之间的同步）。 已支持跨平台，可以在Windows与Linux间进行数据同步。
也可以当作文件复制工具，替代cp和mv命令。 它名称里面的r指的是 remote，rsync 其实就是"远程同步"（remote sync）
……
...
rsync rsync://123.58.224.8:13452/src/
...
> 
<h3>2.4、解题：</h3>
rsync rsync://123.58.224.8:13452/src/tmp/<br/><img alt="" height="751" src="https://img-blog.csdnimg.cn/16a3803c379548b8b17266456b6c6d62.png" width="806"/>
