...
## 三、Less58（GET - challenge - Double -5 queries allowed -Variation 1）

> 
<h3>3.1、简介：（报错回显-GET注入-字符型注入） </h3>
请求方法：GET
方法：报错回显+字符型注入
...
<hr/>?id=1'--+ 
 回显正常<img alt="" height="799" src="https://img-blog.csdnimg.cn/42b63292fead439a84c4b402cc0d36a1.png" width="1200"/>
 
说明为单引号闭合
