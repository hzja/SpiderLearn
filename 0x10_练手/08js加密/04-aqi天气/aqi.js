...
var hexcase = 0, b64pad = "", chrsz = 8, appId = "a01901d3caba1f362d69474674ce477f";
var hexcase = 0;
var b64pad = "";
...
var CryptoJS = CryptoJS || function (h, r) {
    var k = {}, l = k.lib = {}, n = function () {
        ...
        reset: function () {
            ...
            var b = this._3, d = b.words, c = b.sigBytes, e = this.blockSize, f = c / (4 * e),
...
(function () {
    ...
    h.enc.Base64 = {
        stringify: function (b) {
            var e = b.words, f = b.sigBytes, c = this._17;
            b.clamp();
            b = [];
            ...
            var e = b.length, f = this._17, c = f.charAt(64);
...
CryptoJS.lib.Cipher || function (u) {
    var g = CryptoJS, f = g.lib, k = f.Base, l = f.WordArray, q = f.BufferedBlockAlgorithm, r = g.enc.Base64,
        v = g.algo.EvpKDF, n = f.Cipher = q.extend({
            cfg: k.extend(), createEncryptor: function (a, b) {
                ...
                a && this._11(a);
                return this._10()
            }, keySize: 4, ivSize: 4, _12: 1, _33: 2, _5: function (a) {
                return {
    ...
    h.Decryptor = h.extend({
        processBlock: function (a, b) {
            var c = this._8, d = c.blockSize, e = a.slice(b, b + d);
            c.decryptBlock(a, b);
            t.call(this, a, b, d);
            this._14 = e
        }
    ...
    f.BlockCipher = n.extend({
        cfg: n.cfg.extend({mode: m, padding: h}), reset: function () {
            ...
            if (this._16 == this._12) var c = a.createEncryptor; else c = a.createDecryptor, this._20 = 1;
...
(function (E) {
    ...
    q = q.MD5 = s.extend({
        _7: function () {
            ...
            var g = this._9.words, j = m[f + 0], p = m[f + 1], q = m[f + 2], r = m[f + 3], s = m[f + 4], t = m[f + 5],
            ...
            var a = this._3, f = a.words, g = 8 * this._19, j = 8 * a.sigBytes;
            f[j >>> 5] |= 128 << 24 - j % 32;
...
(function () {
    ...
    var F = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], r = r.AES = x.extend({
        _7: function () {
            for (var c = this._13, e = c.words, a = c.sigBytes / 4, c = 4 * ((this._26 = a + 6) + 1), b = this._32 = [], h = 0; h < c; h++) if (h < a) b[h] = e[h]; else {
                var d = b[h - 1];
            ...
            for (var n = this._26, f = c[e] ^ a[0], g = c[e + 1] ^ a[1], k = c[e + 2] ^ a[2], p = c[e + 3] ^ a[3], l = 4, t = 1; t < n; t++) var q = b[f >>> 24] ^ h[g >>> 16 & 255] ^ d[k >>> 8 & 255] ^ j[p & 255] ^ a[l++], r = b[g >>> 24] ^ h[k >>> 16 & 255] ^ d[p >>> 8 & 255] ^ j[f & 255] ^ a[l++], s = b[k >>> 24] ^ h[p >>> 16 & 255] ^ d[f >>> 8 & 255] ^ j[g & 255] ^ a[l++], p = b[p >>> 24] ^ h[f >>> 16 & 255] ^ d[g >>> 8 & 255] ^ j[k & 255] ^ a[l++], f = q, g = r, k = s;
...
function getServerData(method, city, type, start_time, end_time) {
    var param = {};
    param.city = city;
    param.type = type;
...
//     var param = {city: "北京", type: "HOUR", startTime: "2019-05-19 19:00:00", endTime: "2019-05-20 22:00:00"};
//     return getServerData(method, param,0.5);
// }
// getWeatherData()
