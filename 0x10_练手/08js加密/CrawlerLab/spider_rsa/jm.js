...
*/ {
    ...
    * JSreverse the plaintext order to preserve big-endian order.
    */
    i = 0;
...
* this routine, if you JSreverse the plaintext byte order first and then
...
function get_encrypted_password(password) {
    ...
    //16进制字符串(转16进制会发生默写字符串解密错误 比如 d0x0s0)
