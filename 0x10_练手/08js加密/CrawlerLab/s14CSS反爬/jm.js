...
function _0x359c64() {
    var result = {};
    for ($index$ = 0x0; $index$ < _0x44edbf['length']; $index$++) {
        var _0x552262 = _0x59c0a4(_0x44edbf[$index$], ',');
        var _0x50d667 = '';
        for ($itemIndex$ = 0x0; $itemIndex$ < _0x552262['length']; $itemIndex$++) {
            _0x50d667 += _0x13ff1b(_0x552262[$itemIndex$]) + '';
        }
        console.log($index$, _0x50d667);
        result[$index$] = _0x50d667
        // _0x5ba2e2($index$, _0x50d667);
    }
    return result
}
